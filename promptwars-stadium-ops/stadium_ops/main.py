...
This is the main entry point of the Streamlit application. It binds core
services (RAG Q&A, crowd management, volunteer roster, green calculators,
transit monitors) and injects accessibility profiles.
"""
